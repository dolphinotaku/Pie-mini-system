...
function ExportData($httpRequest){
	...
	$exportManager->Initialize("Import/Export Master Template");
...
//	$exportManager->AddTable("staff");
	$exportManager->AddTable("bank");
	$exportManager->AddTable("currency");
	$exportManager->AddTable("holiday");
	
	// set excel header sequence
//	$exportManager->SetSkipExportColumn("staff", "UserID");
	$exportManager->SetSkipExportColumn("currencyentity", "AutoID");
	$exportManager->SetSkipExportColumn("holiday", "AutoID");
...
//	$importManager->AddTable("staff");
	$importManager->AddTable("bank");
	$importManager->AddTable("currency");
	$importManager->AddTable("holiday");
