...
function GetDescription(){
    return "Get exchange rate via API";
}
...
function GetAvailableParameterData(){
	...
	$parameter->Initialize("apiType", "apiType", TaskParameter::DATATYPE_STRING, "Fixer");
    ...
    $parameter = new TaskParameter();
	$parameter->Initialize("fixerAccountType", "fixerAccountType", TaskParameter::DATATYPE_STRING, "Free");
