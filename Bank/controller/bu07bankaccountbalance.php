...
function ExportData($httpRequest){
	...
	$exportManager->Initialize("Import/Export Bank Account Balance Template");
	...
	$exportManager->AddTable("bankaccount");
	$exportManager->AddTable("bankaccountbalance");
	$exportManager->AddTable("bankaccountcurrency");
...
function ImportData($httpRequest){
	...
	$importManager->AddTable("bankaccount");
	$importManager->AddTable("bankaccountbalance");
	//$importManager->AddTable("bankaccountcurrency");
