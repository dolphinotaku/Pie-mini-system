...
*/
	...
	public function insert(){
        ...
        $primaryKeySchema = $this->getPrimaryKeyName();
		if($primaryKeySchema['affected_rows'] == 0){
			throw new Exception("Table '$this->table' was no index defined!");
		}
	...
	function SetSQLValueString($setColumn, $setValue)
	{
		...
		switch (true) {
            ...
            case $type==="date":
                // 20190630
                // remove colon
                // this case for assisn date from a table manager to another table manager
                // 1
                // tableManager->Date = "2019-04-20"
                // becuase the date embed with ' in GET for sql query.
                // tableBManager->Date = tableManager->Date;
